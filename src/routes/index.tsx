...
const SITE_URL = "https://primecutmedia.uk";
const OG_IMAGE = "https://images.unsplash.com/photo-1613977257592-4871e5fcd7c4?auto=format&fit=crop&w=1600&q=85";
...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Prime Cut Media — Cinematic Reels for Luxury Real Estate Agents" },
      { name: "description", content: "Prime Cut Media turns one estate tour into 20 cinematic luxury property reels — scored, captioned and colour-graded for top agents in London, New York, Dubai & beyond." },
      { name: "keywords", content: "luxury real estate video, luxury property videographer, cinematic property reels, real estate reel editing, Instagram reels for real estate agents, TikTok for realtors, luxury property marketing, real estate video editor London, real estate videographer New York, viral property reels, Knight Frank video, Savills video, Sotheby's real estate video, luxury listing video, drone real estate video, prestige property videography" },
      { name: "author", content: "Prime Cut Media" },
      ...
      { property: "og:description", content: "One estate tour. Twenty cinematic reels. A season of social, cut in a week — for the agents listing the world's finest homes." },
      ...
      { property: "og:image:alt", content: "Luxury estate at dusk — Prime Cut Media" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Prime Cut Media — Cinematic Reels for Luxury Real Estate" },
      { name: "twitter:description", content: "One estate tour. Twenty cinematic reels. A season of social, cut in a week." },
      { name: "twitter:image", content: OG_IMAGE },
      { name: "twitter:site", content: "@primecutmedia" },
      { name: "twitter:creator", content: "@primecutmedia" },
          ...
          "@graph": [
            {
              ...
              alternateName: "Prime Cut",
              url: SITE_URL,
              logo: SITE_URL + "/favicon.png",
              image: OG_IMAGE,
              email: "studio@primecutmedia.uk",
              description: "Cinematic reel production studio for luxury real estate agents and brokerages worldwide.",
              foundingDate: "2023",
              areaServed: [
              ...
              sameAs: [
                "https://www.instagram.com/primecutmedia",
                "https://www.tiktok.com/@primecutmedia",
                "https://www.linkedin.com/company/primecutmedia",
              ],
              contactPoint: [{
                "@type": "ContactPoint",
            ...
            },
            {
              ...
              email: "studio@primecutmedia.uk",
              priceRange: "££££",
              areaServed: ["London", "New York", "Dubai", "Worldwide"],
              serviceType: "Luxury Real Estate Video Production",
              aggregateRating: {
            ...
            {
              "@type": "Service",
              name: "Cinematic Real Estate Reel Production",
              provider: { "@id": SITE_URL + "/#organization" },
              areaServed: "Worldwide",
              description: "One luxury property tour, edited into up to twenty cinematic vertical reels for Instagram, TikTok and YouTube Shorts.",
              offers: [
                { "@type": "Offer", name: "The Signature Trim", price: "999", priceCurrency: "GBP", url: SITE_URL + "/#investment" },
                { "@type": "Offer", name: "The Elite Cut", price: "1800", priceCurrency: "GBP", url: SITE_URL + "/#investment" },
                { "@type": "Offer", name: "The Empire Cut", price: "2900", priceCurrency: "GBP", url: SITE_URL + "/#investment" },
              ],
            },
            {
              "@type": "FAQPage",
            ...
            },
            {
              ...
              itemListElement: [
                ...
                { "@type": "ListItem", position: 3, name: "Investment", item: SITE_URL + "/#investment" },
